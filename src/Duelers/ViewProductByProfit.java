 ...
 * @author taghr
 */
public class ViewProductByProfit extends javax.swing.JFrame {

    /**
     * Creates new form ViewProduct
     */
    public ViewProductByProfit() {
        initComponents();
        displayProduct();
    }
    ...
    private static void displayProduct(){
        ...
        String sql = "SELECT ProductName, SellingPrice, CostPrice, "
                + "quantityAvailable, quantitySold FROM product "
                + "ORDER BY((quantitySold-(quantitySold*CostPrice)/SellingPrice)*100) DESC;";
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProductByProfit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
